(function(root, factory) {
  ...
  var InPersonSigner = function InPersonSigner() { 
    var self = this;
    ...
    self.constructFromObject = function(data) {
      ...
      if (data.hostEmail) {
        self.hostEmail = data.hostEmail;
      }
      
      if (data.signerName) {
        self.signerName = data.signerName;
      }
      
      if (data.signerEmail) {
        self.signerEmail = data.signerEmail;
      }
    ...
    /**
     * get Specifies the name of the signing host. It is a required element for In Person Signers recipient Type. \nMaximum Length: 100 characters.
     * @return {String}
     **/
    ...
    /**
     * set Specifies the name of the signing host. It is a required element for In Person Signers recipient Type. \nMaximum Length: 100 characters.
     ...
     **/
    self.setHostEmail = function (hostEmail) {
      self.hostEmail = hostEmail;
    }
    
    /**
     * get Required. The full legal name of a signer for the envelope. \n\nMaximum Length: 100 characters.
     * @return {String}
     **/
    self.getSignerName = function() {
      return self.signerName;
    }

    /**
     * set Required. The full legal name of a signer for the envelope. \n\nMaximum Length: 100 characters.
     * @param {String} signerName
     **/
    self.setSignerName = function (signerName) {
      self.signerName = signerName;
    }
    
    /**
     * get The email address for an InPersonSigner recipient Type. \n\nMaximum Length: 100 characters.
     * @return {String}
     **/
    self.getSignerEmail = function() {
      return self.signerEmail;
    }

    /**
     * set The email address for an InPersonSigner recipient Type. \n\nMaximum Length: 100 characters.
     * @param {String} signerEmail
     **/
    self.setSignerEmail = function (signerEmail) {
  ...
  if (module) {
    module.InPersonSigner = InPersonSigner;
  }
