(function(root, factory) {
  ...
  var TemplateRecipients = function TemplateRecipients() { 
    var self = this;
    ...
    /**
     * set The list of recipient event statuses that will trigger Connect to send updates to the url. It can be a two-part list with:\n\n* recipientEventStatusCode - The recipient status, this can be Sent, Delivered, Completed, Declined, AuthenticationFailed, and AutoResponded.\n* includeDocuments - When set to **true**, the envelope time zone information is included in the message.
  ...
  if (module) {
    module.TemplateRecipients = TemplateRecipients;
  }
