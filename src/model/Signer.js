(function(root, factory) {
  ...
  var Signer = function Signer() { 
    ...
    self.constructFromObject = function(data) {
      ...
      if (data.signInEachLocation) {
        self.signInEachLocation = data.signInEachLocation;
      }
      ...
      if (data.requireSignerCertificate) {
        self.requireSignerCertificate = data.requireSignerCertificate;
      }
      
      if (data.requireSignOnPaper) {
        self.requireSignOnPaper = data.requireSignOnPaper;
      }
      
      if (data.canSignOffline) {
        self.canSignOffline = data.canSignOffline;
      }
      
      if (data.isBulkRecipient) {
        self.isBulkRecipient = data.isBulkRecipient;
      }
      
      if (data.bulkRecipientsUri) {
        self.bulkRecipientsUri = data.bulkRecipientsUri;
      }
      ...
      if (data.excludedDocuments) {
        self.excludedDocuments = data.excludedDocuments;
      }
     ...
     **/
    self.getSignatureInfo = function() {
    ...
    /**
     * get When set to **true**, specifies that the signer must sign in all locations.
     * @return {String}
     **/
    self.getSignInEachLocation = function() {
      return self.signInEachLocation;
    }

    /**
     * set When set to **true**, specifies that the signer must sign in all locations.
     * @param {String} signInEachLocation
     **/
    self.setSignInEachLocation = function (signInEachLocation) {
     ...
     **/
    self.getOfflineAttributes = function() {
      return self.offlineAttributes;
    }

    /**
     * @param {OfflineAttributes} offlineAttributes
     **/
    self.setOfflineAttributes = function (offlineAttributes) {
      self.offlineAttributes = offlineAttributes;
    }
    
    /**
     * get Sets the type of signer certificate required for signing. If left blank, no certificate is required. Only one type of certificate can be set for a signer. The possible values are:\n\n* docusign_express – Requires a DocuSign Express certificate.\n* safe – Requires a SAFE-BioPharma certificate.\n* open_trust – Requires an OpenTrust certificate. \n\n**Important**: There are certain rules and restrictions that must be followed when requiring OpenTrust digital signatures. See [ML:OpenTrust Rules and Restrictions] for more information.
     * @return {String}
     **/
    self.getRequireSignerCertificate = function() {
      return self.requireSignerCertificate;
    }

    /**
     * set Sets the type of signer certificate required for signing. If left blank, no certificate is required. Only one type of certificate can be set for a signer. The possible values are:\n\n* docusign_express – Requires a DocuSign Express certificate.\n* safe – Requires a SAFE-BioPharma certificate.\n* open_trust – Requires an OpenTrust certificate. \n\n**Important**: There are certain rules and restrictions that must be followed when requiring OpenTrust digital signatures. See [ML:OpenTrust Rules and Restrictions] for more information.
     * @param {String} requireSignerCertificate
     **/
    self.setRequireSignerCertificate = function (requireSignerCertificate) {
      self.requireSignerCertificate = requireSignerCertificate;
    }
    
    /**
     * get When set to **true**, the signer must print, sign, and upload or fax the signed documents to DocuSign.
     * @return {String}
     **/
    self.getRequireSignOnPaper = function() {
      return self.requireSignOnPaper;
    }

    /**
     * set When set to **true**, the signer must print, sign, and upload or fax the signed documents to DocuSign.
     * @param {String} requireSignOnPaper
     **/
    self.setRequireSignOnPaper = function (requireSignOnPaper) {
      self.requireSignOnPaper = requireSignOnPaper;
    }
    
    /**
     * get When set to **true**, specifies that the signer can perform the signing ceremony offline.
     * @return {String}
     **/
    self.getCanSignOffline = function() {
      return self.canSignOffline;
    }

    /**
     * set When set to **true**, specifies that the signer can perform the signing ceremony offline.
     * @param {String} canSignOffline
     **/
    self.setCanSignOffline = function (canSignOffline) {
      self.canSignOffline = canSignOffline;
    }
    
    /**
     * get When set to **true**, this signer is a bulk recipient and the recipient information is contained in a bulk recipient file. \n\nNote that when this is true the email and name for the recipient becomes bulk@recipient.com and \"Bulk Recipient\". These fields can not be changed for the bulk recipient.
     * @return {String}
     **/
    self.getIsBulkRecipient = function() {
      return self.isBulkRecipient;
    }

    /**
     * set When set to **true**, this signer is a bulk recipient and the recipient information is contained in a bulk recipient file. \n\nNote that when this is true the email and name for the recipient becomes bulk@recipient.com and \"Bulk Recipient\". These fields can not be changed for the bulk recipient.
     * @param {String} isBulkRecipient
     **/
    self.setIsBulkRecipient = function (isBulkRecipient) {
      self.isBulkRecipient = isBulkRecipient;
    }
    
    /**
     * get Contains a URI for an endpoint that allows you to easily retrieve bulk recipient information.
     * @return {String}
     **/
    self.getBulkRecipientsUri = function() {
      return self.bulkRecipientsUri;
    }

    /**
     * set Contains a URI for an endpoint that allows you to easily retrieve bulk recipient information.
     * @param {String} bulkRecipientsUri
     **/
    self.setBulkRecipientsUri = function (bulkRecipientsUri) {
     ...
     * @return {String}
     **/
    self.getRecipientSuppliesTabs = function() {
      return self.recipientSuppliesTabs;
    }
     ...
     **/
    self.setRecipientSuppliesTabs = function (recipientSuppliesTabs) {
     ...
     * @return {Array}
     **/
    self.getExcludedDocuments = function() {
      return self.excludedDocuments;
    }

    /**
     * set Specifies the documents that are not visible to this recipient. Document Visibility must be enabled for the account and the `enforceSignerVisibility` property must be set to **true** for the envelope to use this.\n\nWhen enforce signer visibility is enabled, documents with tabs can only be viewed by signers that have a tab on that document. Recipients that have an administrative role (Agent, Editor, or Intermediaries) or informational role (Certified Deliveries or Carbon Copies) can always see all the documents in an envelope, unless they are specifically excluded using this setting when an envelope is sent. Documents that do not have tabs are always visible to all recipients, unless they are specifically excluded using this setting when an envelope is sent.
     * @param {Array} excludedDocuments
     **/
    self.setExcludedDocuments = function (excludedDocuments) {
