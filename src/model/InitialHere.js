(function(root, factory) {
  ...
  var InitialHere = function InitialHere() { 
    var self = this;
    ...
    /**
     * get Sets the size for the InitialHere tab. It can be value from 0.5 to 1.0, where 1.0 represents full size and 0.5 is 50% size.
     * @return {Object}
     **/
    ...
    /**
     * set Sets the size for the InitialHere tab. It can be value from 0.5 to 1.0, where 1.0 represents full size and 0.5 is 50% size.
     * @param {Object} scaleValue
     **/
  ...
  if (module) {
    module.InitialHere = InitialHere;
  }
