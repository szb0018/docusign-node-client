(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define([undefined, './CustomFields', './Document', './EmailSettings', './EnvelopeTemplateDefinition', './LockInformation', './Notification', './Recipients'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(undefined, require('./CustomFields'), require('./Document'), require('./EmailSettings'), require('./EnvelopeTemplateDefinition'), require('./LockInformation'), require('./Notification'), require('./Recipients'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    factory(root.Docusign, root.Docusign.CustomFields, root.Docusign.Document, root.Docusign.EmailSettings, root.Docusign.EnvelopeTemplateDefinition, root.Docusign.LockInformation, root.Docusign.Notification, root.Docusign.Recipients);
  }
}(this, function(module, CustomFields, Document, EmailSettings, EnvelopeTemplateDefinition, LockInformation, Notification, Recipients) {
  'use strict';
  ...
  var EnvelopeTemplate = function EnvelopeTemplate() { 
    var self = this;
    
    /**
     * datatype: EnvelopeTemplateDefinition
     **/
    self.envelopeTemplateDefinition = null;
     ...
     **/
    self.getEnvelopeTemplateDefinition = function() {
      return self.envelopeTemplateDefinition;
    }

    /**
     * @param {EnvelopeTemplateDefinition} envelopeTemplateDefinition
     **/
    self.setEnvelopeTemplateDefinition = function (envelopeTemplateDefinition) {
      self.envelopeTemplateDefinition = envelopeTemplateDefinition;
    }
  ...
  if (module) {
    module.EnvelopeTemplate = EnvelopeTemplate;
  }
