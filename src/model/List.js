(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define([undefined, './ErrorDetails', './ListItem', './MergeField'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(undefined, require('./ErrorDetails'), require('./ListItem'), require('./MergeField'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    factory(root.Docusign, root.Docusign.ErrorDetails, root.Docusign.ListItem, root.Docusign.MergeField);
  }
}(this, function(module, ErrorDetails, ListItem, MergeField) {
  'use strict';
  ...
  var List = function List() { 
    ...
    /**
     * get The list of values that can be selected by senders. The list values are separated by semi-colons. Example: [one;two;three;four]\n\nMaximum Length of listItems:  2048 characters.\nMaximum Length of items in the list: 100 characters.
     * @return {Array}
     **/
    ...
    /**
     * set The list of values that can be selected by senders. The list values are separated by semi-colons. Example: [one;two;three;four]\n\nMaximum Length of listItems:  2048 characters.\nMaximum Length of items in the list: 100 characters.
    ...
    /**
     * get The value to use when the item is selected.
     * @return {String}
     **/
    ...
    /**
     * set The value to use when the item is selected.
     * @param {String} value
     **/
